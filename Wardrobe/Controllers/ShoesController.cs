...
namespace Wardrobe.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,ShoeName,ShoePhoto,ShoeTypeID,ColorID,SeasonID,OccasionID")] Shoe shoe)
        {
            ...
            ViewBag.ColorID = new SelectList(db.Colors, "ColorID", "Color1", shoe.ColorID);
            ViewBag.OccasionID = new SelectList(db.Occasions, "OccasionID", "Occasion1", shoe.OccasionID);
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "Season1", shoe.SeasonID);
            ViewBag.ShoeTypeID = new SelectList(db.ShoeTypes, "ShoeTypeID", "ShoeType1", shoe.ShoeTypeID);
            return View(shoe);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,ShoeName,ShoePhoto,ShoeTypeID,ColorID,SeasonID,OccasionID")] Shoe shoe)
        {
            if (ModelState.IsValid)
            {
